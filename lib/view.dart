                          ...
                          return Column(
                            children: [
                              Padding(
                                ...
                                child: Card(
                                  child: Image.network(
                                      '${Con.url}rental/${snapshot.data[index]['image']}',fit: BoxFit.fill,height: 365,width: MediaQuery.of(context).size.width,),
                                  // child: Image.asset(
                                  //     'assets/img/seltos-exterior-right-front-three-quarter.webp'),
                                ),
                              ),
                              SizedBox(height: 10,),
                              Text(
